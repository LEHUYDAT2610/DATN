...
public class RegisterController {
	...
	/*@PostMapping("/confirmOtpRegister")
	public ModelAndView confirmRegister(@ModelAttribute("user") User dto,
										@RequestParam("password") String password, @RequestParam("otp") String otp) {
		...
		if (otp.equals(String.valueOf(session.getAttribute("otp")))) {
			...
			model.addObject("error", "Mã xác thực OTP không chính xác, hãy thử lại!");
			model.setViewName("web/confirmOtpRegister");
		}
		return model;
	}*/
